...
int main(){
    ...
    cout<<"Count of leaf nodes: "<<t.leafNodeCount(t.getRoot())<<endl;
    cout<<"Count of degree 1 or degree 2 nodes: "<<t.deg1ordeg2NodeCount(t.getRoot())<<endl;
    cout<<"Count of degree 1 nodes: "<<t.deg1NodeCount(t.getRoot())<<endl;
